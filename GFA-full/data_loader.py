...
class SYSUData(data.Dataset):
    def __init__(self, data_dir,  transform1=None, transform2=None, transform3=None, colorIndex = None, thermalIndex = None):
        ...
        data_dir = '/mnt/data/ljq/SYSU-MM01/'
    ...
    def __getitem__(self, index):
        ...
        img3,  target3 = self.train_color_image[self.cIndex[index]],  self.train_color_label[self.cIndex[index]]
...
class RegDBData(data.Dataset):
    def __init__(self, data_dir, trial, transform1=None, transform2=None, transform3=None, colorIndex = None, thermalIndex = None):
        # Load training images (path) and labels
        data_dir = '/mnt/data/ljq/RegDB/'
...
class TestDataOld(data.Dataset):
    def __init__(self, data_dir, test_img_file, test_label, transform=None, img_size = (128,256)):
